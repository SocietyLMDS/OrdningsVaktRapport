...
{
    class when_renewing_company_password_because_you_forgot_with_an_email_address_that_doesnt_exist
    {
        ...
        private Because Of = () =>
            {
                _forgotResponse = Repository.ForgotPassword("managerkassiim@hotmail.com");
            };

        private It an_exception_should_be_thrown = () =>
        {
            _forgotResponse.ShouldEqual("UnSucceeded");
        };
    }
}
