...
{
    class when_renewing_company_password_because_you_forgot_with_an_invalid_email_address
    {
        ...
        private Because Of = () =>
        {
            exception = Catch.Exception(() => Repository.ForgotPassword("manager.hotmail.com"));
        };

        private It an_exception_should_be_thrown = () =>
            {
                exception.Message.ShouldEqual("The email address is not a valid format");
            };
    }
}
