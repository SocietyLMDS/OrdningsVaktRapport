...
{
    class when_modifying_a_company_without_email_address
    {
        ...
        private Because Of = () =>
        {
            ...
            getCompany.EmailAddress = "";
            exception = Catch.Exception(() => _repository.ModifyCompany(getCompany));
        };

        private It an_exception_should_be_thrown = () =>
        {
            exception.Message.ShouldEqual("You cannot modify a new company without an email address");
        };
    }
}
