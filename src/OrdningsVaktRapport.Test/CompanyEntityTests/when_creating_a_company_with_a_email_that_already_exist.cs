...
{
    class when_creating_a_company_with_a_email_that_already_exist
    {
        ...
        private Because Of = () =>
            {
                ...
                _company2.EmailAddress = "manager@hotmail.com";
        ...
        {
            _exception.Message.ShouldEqual("A company with that email address already exist");
        };
    }
}
