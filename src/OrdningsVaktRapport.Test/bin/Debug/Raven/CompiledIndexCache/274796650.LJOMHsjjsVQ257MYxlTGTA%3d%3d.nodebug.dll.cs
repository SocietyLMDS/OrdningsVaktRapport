...
public class Index_Auto_2fCompanyEntities_2fByEmailAddressAndUsername : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Auto_2fCompanyEntities_2fByEmailAddressAndUsername()
	{
		this.ViewText = @"from doc in docs.CompanyEntities
select new { Username = doc.Username, EmailAddress = doc.EmailAddress }";
