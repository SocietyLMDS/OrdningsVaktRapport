...
{
    class when_deleting_an_object_from_a_customer
    {
        ...
        private Because Of = () =>
        {
            ...
            _customerObjecResponse = Repository.DeleteCustomerObject(customerObject);
            _customerReturnedAfterDelete = Repository.GetCustomerById(Customer);
        };

        private It should_delete_an_object_from_a_customer = () =>
            {
