...
{
    class when_adding_an_object_to_a_customer_without_a_name
    {
        ...
        private Because Of = () =>
        {
            ...
            _exception = Catch.Exception(() => Repository.AddObjectToCustomer(customerObject));
        };

        private It should_throw_an_exception = () =>
            {
                _exception.Message.ShouldEqual("You cannot add an object without a name");
            };
    }
}
