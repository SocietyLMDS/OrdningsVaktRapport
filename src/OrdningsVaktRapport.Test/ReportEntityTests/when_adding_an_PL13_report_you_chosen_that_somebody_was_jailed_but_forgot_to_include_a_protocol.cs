...
{
    class when_adding_an_PL13_report_you_chosen_that_somebody_was_jailed_but_forgot_to_include_a_protocol
    {
        ...
        private Because Of = () =>
        {
            ...
            _report.ReportModel = new ReportModel { Avl = true, Avv = true, Omh = new Omh { SkyddsVisitation = true, Fangsel = true, Protocol = "" } };
