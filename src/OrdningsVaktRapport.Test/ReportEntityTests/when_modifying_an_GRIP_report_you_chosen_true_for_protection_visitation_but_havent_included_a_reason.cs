...
{
    class when_modifying_an_GRIP_report_you_chosen_true_for_protection_visitation_but_havent_included_a_reason
    {
        ...
        private Because Of = () =>
        {
            ...
            _reportSaved.ReportModel.Omh.SkyddsVisitation = true;
        ...
        {
            _exception.Message.ShouldEqual("You've chosen true that somebody was put on protection visitation but forgot to include a reason");
        };
    }
}
