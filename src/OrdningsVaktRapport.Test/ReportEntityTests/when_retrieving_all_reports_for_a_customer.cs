...
{
    class when_retrieving_all_reports_for_a_customer
    {
        ...
        private Because Of = () =>
        {
            _reports = Repository.GetAllReportsByCustomer(_customer);
        };

        private It Should_retrieve_all_reports_for_a_company = () =>
        {
