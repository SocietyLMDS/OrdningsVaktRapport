...
{
    class when_modifying_an_PL13_report_you_chosen_that_somebody_was_jailed_but_forgot_to_include_a_protocol
    {
        ...
        private Establish Context = () =>
        {
            ...
            _report.ReportModel = new ReportModel { Avl = true, Avv = true, Omh = new Omh { SkyddsVisitation = true, Fangsel = true, Protocol = "Protocol" } };
        ...
        private Because Of = () =>
        {
            ...
            _reportSaved.ReportModel.Avl = false;
            _reportSaved.ReportModel.Avv = false;
            _reportSaved.ReportModel.Omh.SkyddsVisitation = false;
            _reportSaved.ReportModel.Omh.Fangsel = true;
            _reportSaved.ReportModel.Omh.Protocol = "";
            _exception = Catch.Exception(() => Repository.ModifyReport(_reportSaved));
        };

        private It Should_modify_an_PL13_report = () =>
            {
