...
{
    class when_adding_an_GRIP_report_you_chosen_true_for_protection_visitation_but_havent_included_a_reason
    {
        ...
        private Because Of = () =>
        {
            ...
            _report.ReportModel = new ReportModel { Omh = new Omh { SkyddsVisitation = true, Fangsel = true, Protocol = "Protocol", Anledning = "" } };
