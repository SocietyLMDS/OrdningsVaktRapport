...
{
    class when_retrieving_all_reports_by_an_employee
    {
        ...
        private Because Of = () =>
        {
            _reports = Repository.GetAllReportsByEmployee(_employee);
        };

        private It Should_retrieve_all_reports_for_an_employee = () =>
        {
            _reports.Count.ShouldBeGreaterThan(0);
            var fbs = _reports.ElementAt(0);
            var pl13 = _reports.ElementAt(1);
            var grip = _reports.ElementAt(2);
