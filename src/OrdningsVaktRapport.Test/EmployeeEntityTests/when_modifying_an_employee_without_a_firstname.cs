...
{
    class when_modifying_an_employee_without_a_firstname
    {
        ...
        private It should_create_a_new_employee = () =>
        {
            ...
            _exception.Message.ShouldEqual("You cannot modify a new employee without a firtname");
        };
    }
}
