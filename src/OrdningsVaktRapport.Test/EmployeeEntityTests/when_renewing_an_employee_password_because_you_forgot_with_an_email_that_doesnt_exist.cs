...
{
    class when_renewing_an_employee_password_because_you_forgot_with_an_email_that_doesnt_exist
    {
        ...
        private Because of = () =>
        {
            _forgotResponse = Repository.ForgotPassword("ladjikollie@aklkas.com");
        };
