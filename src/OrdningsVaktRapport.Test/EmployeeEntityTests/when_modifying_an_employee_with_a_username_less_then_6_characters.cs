...
{
    class when_modifying_an_employee_with_a_username_less_then_6_characters
    {
        ...
        {
            _exception.Message.ShouldEqual("A username cannot be chorter then 6 characters");
        };
    }
}
