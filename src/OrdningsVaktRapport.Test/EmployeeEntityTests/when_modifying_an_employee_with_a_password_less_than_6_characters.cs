...
{
    class when_modifying_an_employee_with_a_password_less_than_6_characters
    {
        ...
        private It should_create_a_new_employee = () =>
            {
                _exception.Message.ShouldEqual("A password cannot be chorter then 6 characters");
            };
    }
}
