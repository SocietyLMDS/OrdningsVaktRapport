...
{
    class when_modifying_an_employee_without_a_username
    {
        ...
        {
            _exception.Message.ShouldEqual("You cannot modify a new employee without a username");
        };
    }
}
