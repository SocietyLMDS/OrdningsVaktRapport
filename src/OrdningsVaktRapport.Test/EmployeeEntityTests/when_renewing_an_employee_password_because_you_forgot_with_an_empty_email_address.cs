...
{
    class when_renewing_an_employee_password_because_you_forgot_with_an_empty_email_address
    {
        ...
        private Because of = () =>
        {
            _exception = Catch.Exception(() => Repository.ForgotPassword(""));

        };

        private It should_create_a_new_employee = () =>
        {
            _exception.Message.ShouldEqual("The email address is null or empty");
        };
    }
}
