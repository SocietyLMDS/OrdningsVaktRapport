...
{
    class when_modiying_an_employee_without_a_password
    {
        ...
        {
            _exception.Message.ShouldEqual("You cannot modify a new employee without a password");
        };
    }
}
