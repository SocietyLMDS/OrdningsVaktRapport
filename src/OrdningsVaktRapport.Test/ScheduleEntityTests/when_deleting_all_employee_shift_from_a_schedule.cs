...
{
    class when_deleting_all_employee_shift_from_a_schedule
    {
        ...
        private Because of = () =>
        {
            ...
            Employee2ShiftsAfterDelete = Repository.GetAllEmployeeShifts(Employee2);
            Employee3Shifts = Repository.GetAllEmployeeShifts(Employee3);

        };

        private It should_delete_all_employee_shifts_from_a_schedule_ = () =>
        {
            EmployeeShifts.Count.ShouldEqual(3);
            Employee2Shifts.Count.ShouldEqual(3);
            Employee2ShiftsAfterDelete.Count.ShouldEqual(0);
