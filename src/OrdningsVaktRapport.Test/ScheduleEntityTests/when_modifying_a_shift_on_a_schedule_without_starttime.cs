...
{
    class when_modifying_a_shift_on_a_schedule_without_starttime
    {
        ...
        private Because of = () =>
        {
            ...
            SavedShift.StartTime = new DateTime();
            Exception = Catch.Exception(() => Repository.ModifyShiftOnSchedule(SavedShift));
        };

        private It should_throw_an_exception = () =>
        {
            Exception.Message.ShouldEqual("You cannot modify a shift without a start time");
        };
    }
}
