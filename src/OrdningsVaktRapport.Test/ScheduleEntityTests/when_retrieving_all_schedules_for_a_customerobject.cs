...
{
    class when_retrieving_all_schedules_for_a_customerobject
    {
        ...
        protected static List<ScheduleEntity> AllCustomerObjectSchedules;
        ...
        private Because of = () =>
        {
            ...
            AllCustomerObjectSchedules = Repository.GetCustomerObjectSchedules(CustomerObject);
        };

        private It should_retrieve_all_schedules_for_a_customerobject = () =>
        {
            AllCustomerObjectSchedules.Count.ShouldBeGreaterThan(0);
        };
