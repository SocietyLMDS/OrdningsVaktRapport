...
{
    class when_adding_a_shift_to_a_schedule_with_a_endtime_thats_less_than_startime
    {
        ...
        {
            Exception.Message.ShouldEqual("You cannot add a shift with a end time that's less than the start time");
        };
    }
}
