...
{
    class when_deleting_a_shift_a_from_a_schedule
    {
        ...
        protected static List<Shift> EmployeeShiftList = new List<Shift>();
        protected static List<Shift> EmployeeShiftListAfterDelete = new List<Shift>();
        ...
        private Because of = () =>
        {
            ...
            EmployeeShiftList = Repository.GetAllEmployeeShifts(Employee);
            Responses = Repository.DeleteShiftFromSchedule(EmployeeShiftList[1]);
            ReturnedScheduleAfterDelete = Repository.GetScheduleById(Schedule);

        };

        private It should_delete_a_shifts_from_a_schedule = () =>
        {
            ReturnedSchedule.Schedules.Count.ShouldEqual(3);
            Responses.ShouldEqual("Succeeded");
            ReturnedScheduleAfterDelete.Schedules.Count.ShouldEqual(2);
        };
    }
}
