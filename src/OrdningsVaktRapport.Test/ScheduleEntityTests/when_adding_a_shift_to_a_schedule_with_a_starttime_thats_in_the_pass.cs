...
{
    class when_adding_a_shift_to_a_schedule_with_a_starttime_thats_in_the_pass
    {
        ...
        {
            Exception.Message.ShouldEqual("You cannot add a shift with a start time that's in the pass");
        };
    }
}
