...
{
    class when_deleting_a_schedule_from_a_company
    {
        ...
        private Because of = () =>
        {
            ...
            Responses = Repository.DeleteSchedule(schedule2);
            AllCompanySchedulesAfterDelete = Repository.GetAllSchedules(Company);
        };

        private It should_delete_a_schedules_from_a_company = () =>
        {
            Responses.ShouldEqual("Succeeded");
            AllCompanySchedules.Count.ShouldEqual(3);
            AllCompanySchedulesAfterDelete.Count.ShouldEqual(2);
        };
    }
}
