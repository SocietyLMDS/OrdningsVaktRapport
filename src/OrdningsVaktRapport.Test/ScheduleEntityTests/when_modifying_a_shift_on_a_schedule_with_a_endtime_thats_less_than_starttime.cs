...
{
    class when_modifying_a_shift_on_a_schedule_with_a_endtime_thats_less_than_starttime
    {
        ...
        private Because of = () =>
        {
            ...
            SavedShift.EndTime = DateTime.Now.AddMinutes(10);
        ...
        {
            Exception.Message.ShouldEqual("You cannot modify a shift with a end time that's less than the start time");
        };
    }
}
