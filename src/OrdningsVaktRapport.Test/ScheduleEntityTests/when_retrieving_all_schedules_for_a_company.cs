...
{
    class when_retrieving_all_schedules_for_a_company
    {
        ...
        private Because of = () =>
        {
            ...
            Reponses = Repository.AddSchedule(schedule2);
            Reponses = Repository.AddSchedule(schedule3);
            AllCompanySchedules = Repository.GetAllSchedules(Company);
        };

        private It should_retrieve_all_schedules_for_a_company = () =>
            {
