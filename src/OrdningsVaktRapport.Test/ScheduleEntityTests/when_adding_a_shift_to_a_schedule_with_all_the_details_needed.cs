...
{
    class when_adding_a_shift_to_a_schedule_with_all_the_details_needed
    {
        ...
        private Because of = () =>
        {
            ...
            ReturnedShift = Repository.GetShiftById(Shift);

        };

        private It should_return_the_correct_shift_object = () =>
        {
            ReturnedShift.Id.ShouldEqual(ShiftId);
            ReturnedShift.EmployeeId.ShouldEqual(EmployeeId);
            ReturnedShift.ScheduleId.ShouldEqual(ScheduleId);
            ReturnedShift.Status.ShouldEqual("Assigned");
        };
    }
}
